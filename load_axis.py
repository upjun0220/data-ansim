...
QUADRANTS = {
    (True, False): ("① 증설 최우선", "상권 효과 큼 · 부하 분산됨 → 충전기 우선 증설"),
    (True, True): ("② 증설+시간대 분산 유도", "상권 효과 큼 · 부하 한 시각에 몰림 → 증설과 함께 시간대별 요금·예약으로 분산"),
    (False, False): ("③ 상권 연계 프로그램 우선", "상권 효과 작음 · 계통 여유 → 충전 대기 연계 할인 등 상권 프로그램 먼저"),
    (False, True): ("④ 신규 투자 최후순위", "상권 효과 작음 · 부하 집중 → 신규 투자 후순위"),
}
