...
**현재 기준은 루트의 V10 HTML(`충전리플맵4_2-07_08절-전력공학축확장안_v10.html`)과 이 README다.** V9 HTML은 이력용으로 남긴다. 실측 변압기 정격·주거지 접속관계·취약계층 수혜를 확보한 분석이 아니며, 정전 예방·교체비 절감은 입증한 성과가 아니다. 결합점수는 실제 설치 지점 선정 결과가 아니라 법정동별 현장 검토 순서다.
